...
class GameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main)  // Din layoutfil
    ...
    private fun onHighButtonClicked() {
        // Drar ett kort för High och visa det
        drawnCard = drawCard()
    ...
    private fun onLowButtonClicked() {
        // Drar ett kort för Low och visa det
        drawnCard = drawCard()
    ...
    private fun onRulesButtonClicked() {
        // Navigera till MainActivity2 när användaren trycker på "RULES"
